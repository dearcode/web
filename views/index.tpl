    ...
    <div class="panel panel-main">
        ...
        <div class="hd">
            ...
            <div class="panel-tab" id="j-tabPanelMainHd">
                <ul class="clearfix">
                    <li class="selected" rel="recent-contacts" id="recent-contacts">
                        <span class="i i-rc" title="最近会话"></span>
                        <span id="msgcounter" class="i i-rmsg-num" style="display:none;"></span>
                    </li>
                    <li rel="contact" id="tabPanelMainHd-contacts">
                        <span class="i i-contact" title="联系人"></span>
                    </li>
                    <li rel="group" id="tabPanelMainHd-group">
                        <span class="i i-group" title="群"></span>
                    </li>
                    <!--
                    <li rel="org-tree" id="tabPanelMainHd-org">
                        <span class="i i-org" title="组织架构"></span>
                    </li>
                    -->
                </ul>
            </div>
        ...
        <div class="bd">
            <div class="panel-cont-tab" id="j-tabPanelMainBd">
                ...
                <div class="contact" id="jd-contact">
		            ...
		            <div class="add-group" id="jd-add-group" title="添加分组">
                        <span class="i"></span>
                    </div>
	                <div class="modify-group" id="jd-modify-group" title="管理分组">
                        <span class="i"></span>
                    </div>
                </div>

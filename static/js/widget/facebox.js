...
define(function(require, exports, module) {
    ...
    (function($) {
        ...
        <div id="facebox" style="display:none;"> \
          <div class="popup"> \
            ...
            loading: function() {
                ...
                $(document).bind('keydown.facebox',
                    function(e) {
                        if (e.keyCode == 27) $.facebox
                            .close()
                        return true
                    })
            ...
            reveal: function(data, klass) {
                $(document).trigger(
                    'beforeReveal.facebox')
                if (klass) $('#facebox .content').addClass(
                    klass)
        ...
        function init(settings) {
            ...
            $('#facebox .close_image').attr('src', $.facebox.settings
                .closeImage)
        }
        ...
        function getPageHeight() {
            ...
            if (self.innerHeight) { // all except Explorer
                ...
                .clientHeight) { // Explorer 6 Strict Mode
        ...
        function skipOverlay() {
            return $.facebox.settings.overlay == false || $.facebox
        ...
        function showOverlay() {
            ...
            $('#facebox_overlay').hide().addClass(
                    "facebox_overlayBG")
                .css('opacity', $.facebox.settings.opacity)
                //.click(function() { $(document).trigger('close.facebox') })    //默认是点击页面就关闭弹框的，没提供配置项，只能注释掉这一行了！！！！
                .fadeIn(200)
            return false
        }
        ...
        function hideOverlay() {
            ...
            $('#facebox_overlay').fadeOut(200, function() {
                $("#facebox_overlay").removeClass(
                    "facebox_overlayBG")
                $("#facebox_overlay").addClass(
                    "facebox_hide")

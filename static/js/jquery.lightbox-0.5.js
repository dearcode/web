...
(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageBtnPrev: '/static/img/20130514A.png', // (string) Path and the name of the prev button image
			imageBtnNext: '/static/img/20130514A.png', // (string) Path and the name of the next button image
		...
		function _start(objClicked, jQueryMatchedObj) {
			...
			if (jQueryMatchedObj.length == 1) {
				...
				for (var i = 0; i < jQueryMatchedObj.length; i++) {
					settings.imageArray.push(new Array(jQueryMatchedObj[i].getAttribute(
						'href'), jQueryMatchedObj[i].getAttribute('title')));
				}
			}
			...
			_set_image_to_view();
			$("#lightbox-nav").attr("title",
				"\u5feb\u6377\u952e\uff1a\u4e0a\u4e00\u5f20" + settings.keyToPrev +
				"\uff0c\u4e0b\u4e00\u5f20" + settings.keyToNext + "\uff0c\u5173\u95ed" +
				settings.keyToClose);
		...
		function _set_interface() {
			...
			$('body').append(
				'<iframe id="jquery-overlay" name="overlay"></iframe><div id="jquery-overlay-div"></div><div id="jquery-lightbox" title="快捷键：上一张p，下一张n，关闭c"><a href="#" class="im-pop-close" id="lightbox-secNav-btnClose" title="关闭"></a><div class="im-pop-view-pic" id="lightboxWrap"><div class="pic-trigger">'
				//                +'<a href="javascript:;" class="go-origin-pic" title="查看原图"></a>'
				+
				'<a href="javascript:;" id="seeFull" class="pic-zoom" title="放大图片"></a>' +
				'</div><div id="lightbox-container-image-box"><div id="lightbox-container-image"><img id="lightbox-image"><div id="lightbox-loading"><a href="#" id="lightbox-loading-link"><img src="' +
				settings.imageLoading +
				'"></a></div></div></div><div id="lightbox-container-image-data-box"></div><a href="#" class="im-slide-prev im-icon-slide-prev" title="前一个" id="lightbox-nav-btnPrev"></a><a href="#" class="im-slide-next im-icon-slide-next" title="后一个" id="lightbox-nav-btnNext"></a>'
